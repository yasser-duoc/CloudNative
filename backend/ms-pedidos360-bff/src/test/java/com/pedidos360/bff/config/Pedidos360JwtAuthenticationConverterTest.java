...
class Pedidos360JwtAuthenticationConverterTest {

    private final Pedidos360JwtAuthenticationConverter converter = new Pedidos360JwtAuthenticationConverter();
    ...
    void mapsRolesAndScopesToAuthorities() {
        Jwt jwt = Jwt.withTokenValue("token")
                .header("alg", "RS256")
                .subject("user-123")
                .claim("preferred_username", "test@pedidos360.cl")
        ...
        assertThat(token.getName()).isEqualTo("test@pedidos360.cl");
    }
